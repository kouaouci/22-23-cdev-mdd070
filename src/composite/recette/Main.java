...
public class Main {
    public static void main(String[] args) {
        ...
        // TODO
        double prixTotalComposite = pizza.getPrix ();
        System.out.println ( "Le prix total de la pizza est " + prixTotalComposite );
   ...
   /*    private static double calculerPrixRecette(Recette recette) {
        ...
        // Prix des ingredients
           ...
           for (Ingredient ingredient : tousSesIngredientsDirects) {
               ...
               // TODO
               double prix= ingredient.getPrix();
